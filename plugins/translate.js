	...
	"Web":{
        ...
        translate._debug("WARNING: Zotero.selectItems should be called with an object, not an array");
          ...
          haveAsyncHandler = !callbackExecuted;
              ...
              Zotero.debug('translate.incrementAsyncProcesses("Zotero.selectItems()");');
              ...
              Zotero.debug('callback(returnedItems);');
...
Zotero.Translate.Base.prototype = {
    ...
    var _me = this;
    Zotero.HTTP.doGet("http://localhost:8080/public/js/savetoflow.js", function (xmlhttp) {
