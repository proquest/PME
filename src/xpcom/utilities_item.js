...
var Utilities_Item = {
    ...
    itemFromCSLJSON: function(item, cslItem) {
        ...
        else if (Zotero.Schema.CSL_TYPE_MAPPINGS_REVERSE && Zotero.Schema.CSL_TYPE_MAPPINGS_REVERSE[cslItem.type]) {
    ...
    itemToAPIJSON: function(item) {
        ...
        for(var field in item) {
            ...
            if(field === "itemType" || field === "attachments" || field === "baseName") {
                newItem[field] = val;
