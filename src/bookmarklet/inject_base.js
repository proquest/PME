...
function startTranslation() {
	...
	zoteroIFrame.src = ZOTERO_CONFIG.BOOKMARKLET_URL + "iframe" + ie + ".html" + "?referrer=" + encodeURIComponent(referrer) + "&pageTitle=" + encodeURIComponent(window.parent.document.title) + "&EXT_SERVICE_PROVIDER="+encodeURIComponent(window.EXT_SERVICE_PROVIDER) + "&PME_SERVICE_PROVIDER="+encodeURIComponent(window.PME_SERVICE_PROVIDER);
	zoteroIFrame.style.display = "none";
