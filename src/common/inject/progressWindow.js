...
Zotero.ProgressWindow = new function() {
	...
	var cssHeadline = {"fontFamily":"'Roboto', Helvetica, Arial, sans-serif", "fontSize":"15px",
		"overflow":"hidden",
		"whiteSpace":"nowrap", "textOverflow":"ellipsis"};
	var cssHeadlineIcon = {"display":"none", "width":"16px", "height":"16px",
		"backgroundPosition":"center", "backgroundRepeat":"no-repeat",
		"verticalAlign":"-3px"};
	var cssItem = {"fontSize":"15px", "margin":"4px 0 4px 0"};
	var cssIcon = {"position":"absolute", "fontSize":"15px", "width":"16px", "height":"16px",
		"backgroundPosition":"0", "backgroundRepeat":"no-repeat"};
	var cssItemText = {"fontFamily":"'Roboto', Helvetica, Arial, sans-serif",
		"fontSize":"13px", "verticalAlign":"middle", "overflow":"hidden",
		"whiteSpace":"nowrap", "lineHeight":"11px", "margin":"0"};
	var cssDescription = {"fontFamily":"'Roboto', Helvetica, Arial, sans-serif", "fontSize":"13px",
